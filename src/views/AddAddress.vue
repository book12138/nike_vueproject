<template>
  <div>
    ...
    <div class="saveBtn" @click="commitNewAddressInfo">保存</div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    /** 提交新地址信息 */
    commitNewAddressInfo () {
      if (this.consignee !== '' && this.phoneNumber !== '' && this.detailAddress !== '' &&
      this.provinceName !== '' && this.cityName !== '' && this.districtName !== '') {
        this.$axios.post(`${api.address}/api/ShippingAddress`, {
          consignee: this.consignee,
          phoneNumber: this.phoneNumber,
          region: `${this.provinceName} ${this.cityName} ${this.districtName}`,
